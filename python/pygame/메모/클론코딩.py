...
stage_height = stage_size[1] #스테이지의 높이 위에 캐리거를 두기 위해 사용
...
ball_images = [
    pygame.image.load(os.path.join(image_path,"볼1.png")),
    pygame.image.load(os.path.join(image_path,"볼2.png")),
    pygame.image.load(os.path.join(image_path,"볼3.png")),
    pygame.image.load(os.path.join(image_path,"볼4.png"))]
